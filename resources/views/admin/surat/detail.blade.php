...
function printSurat() {
    ...
    frame.onload = function() {
        if(frame.getAttribute('src') !== "" && frame.getAttribute('src') !== "about:blank") {
            ...
            // Tampilkan tombol selesai setelah jendela print terbuka
...
function tolakSurat() {
    let alasan = prompt("Masukkan alasan penolakan berkas:");
    if (alasan) {
        // Logika pengiriman form tolak bisa diletakkan di sini
        alert("Fungsi tolak sedang diproses dengan alasan: " + alasan);
    }
}
</script>
@endsection